...
{
    class DBPrecinctMayor
    {
        private static string tablename = "mayor_tabulation";
        ...
        public DBPrecinctMayor()
        {

        }

        public DBPrecinctMayor(int candidate_id, int votes)
        {
        ...
        public static DBPrecinctMayor GetDataByPrecinct(string precinct, string municipality, int candidate_id)
        {
            DBPrecinctMayor data = null;
        ...
        public static List<DBPrecinctMayor> SumationDataTabulation(string municipality)
        {
            List<DBPrecinctMayor> data = new List<DBPrecinctMayor>();
            ...
            try
            {
                ...
                if (reader.HasRows)
                {
                    while (reader.Read())
                    {
                        DBPrecinctMayor rawData = new DBPrecinctMayor();
