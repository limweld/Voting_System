...
{
    class DBPrecinctCouncilors
    {
        private static string tablename = "councilors_tabulation";
        ...
        public DBPrecinctCouncilors()
        {

        }

        public DBPrecinctCouncilors(int candidate_id, int votes)
        {
        ...
        public static DBPrecinctCouncilors GetDataByPrecinct(string precinct, string municipality, int candidate_id)
        {
            DBPrecinctCouncilors data = null;
        ...
        public static List<DBPrecinctCouncilors> SumationDataTabulation(string municipality)
        {
            List<DBPrecinctCouncilors> data = new List<DBPrecinctCouncilors>();
            ...
            try
            {
                ...
                if (reader.HasRows)
                {
                    while (reader.Read())
                    {
                        DBPrecinctCouncilors rawData = new DBPrecinctCouncilors();
