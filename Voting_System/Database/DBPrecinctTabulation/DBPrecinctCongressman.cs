...
{
    class DBPrecinctCongressman
    {
        private static string tablename = "congressman_tabulation";
        ...
        public DBPrecinctCongressman()
        {

        }

        public DBPrecinctCongressman(int candidate_id, int votes)
        {
        ...
        public static DBPrecinctCongressman GetDataByPrecinct(string precinct,string municipality, int candidate_id)
        {
            DBPrecinctCongressman data = null;
            ...
            try
            {
                ...
                {
                    reader.Read();
                    data = new DBPrecinctCongressman();
        ...
        public static List<DBPrecinctCongressman> SumationDataTabulation(string municipality)
        {
            List<DBPrecinctCongressman> data = new List<DBPrecinctCongressman>();
            ...
            try
            {
                ...
                if (reader.HasRows)
                {
                    while (reader.Read())
                    {
                        DBPrecinctCongressman rawData = new DBPrecinctCongressman();
