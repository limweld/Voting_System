...
{
    public partial class Mayor : MetroForm
    {
        public Mayor()
        {
            InitializeComponent();
        ...
        private void loadChart()
        {
            ...
            List<DBPrecinctMayor> rec = DBPrecinctMayor.SumationDataTabulation(comboBox_Municipality.Text);
            foreach (DBPrecinctMayor data in rec)

                bindingsource.Add(new DBPrecinctMayor(
                data.Candidate_id,
                data.Votes
                ));
        ...
        private void Mayor_FormClosed(object sender, FormClosedEventArgs e)
        {
            timer1.Stop();
        }
